...
A & { type: AKey } | B & { type: BKey } | C & { type: CKey } | D & { type: DKey } | E & { type: EKey } | F & { type: FKey } | G & { type: GKey } | H & { type: HKey } | I & { type: IKey } | J & { type: JKey } | K & { type: KKey } | L & { type: LKey } | M & { type: MKey } | N & { type: NKey }, 'type'>
} => {
...
{ type: AKey } | { type: BKey } | { type: CKey } | { type: DKey } | { type: EKey } | { type: FKey } | { type: GKey } | { type: HKey } | { type: IKey } | { type: JKey } | { type: KKey } | { type: LKey } | { type: MKey } | { type: NKey }, "type">
  const format = (
    adt: RouteAdt
  ): string => {
